...
gerarPdfBtn.addEventListener("click", () =>{
    ...
    if(doc.revisoes.length > 0){
        doc.revisoes.forEach((rev, index) => {
            ...
            const maxwWidth = 165; // Largura máxima do texto na página
            const comentarioLines = pdf.splitTextToSize(`- Comentário: ${rev.comentario}`, maxwWidth);
